...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'xyzw@7pnbyt.onmicrosoft.com',
  ...
  links: [
    {
      name: '1',
      link: 'https://115cdn.com/s/swsl8ih336z',
    },
  ],
